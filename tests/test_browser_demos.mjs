...
test.describe('New demo presets', () => {
  for (const [preset, needle] of [['rtc_clock', '12:00:01'], ['servo', 'deg=10'], ['dac_sine', 'adc='], ['i2c_scan', 'found=2'], ['can_chat', 'rx id=100'], ['stopwatch', 'Stopwatch demo'], ['pwm_wave', 'duty=143 ccr=143']]) {
